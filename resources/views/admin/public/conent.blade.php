                            ...
                            <ul class="conversation-list nicescroll">
                                <li class="clearfix">
                                    <div class="chat-avatar">
                                        <img src="/admin/Picture/avatar-2.jpg" alt="male">
                                        <i>10:00</i>
                                    </div>
                                ...
                                <li class="clearfix odd">
                                    <div class="chat-avatar">
                                        <img src="/admin/Picture/avatar-3.jpg" alt="Female">
                                        <i>10:01</i>
                                    </div>
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                                ...
                                <li class="clearfix odd">
                                    <div class="chat-avatar">
                                        <img src="/admin/Picture/avatar-3.jpg" alt="male">
                                        <i>10:02</i>
                                    </div>
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                    ...
                    <div class="portlet-body">
                        <ul class="list-group list-group-lg">
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-3.jpg" class="thumb-sm br-radius">
                                </a>
                            ...
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-4.jpg" class="thumb-sm br-radius">
                                </a>
                            ...
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-5.jpg" class="thumb-sm br-radius">
                                </a>
                            ...
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-6.jpg" class="thumb-sm br-radius">
                                </a>
                            ...
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-7.jpg" class="thumb-sm br-radius">
                                </a>
                                <span class="pull-right label bg-warning inline m-t-10">Webdeveloper</span>
                                <a href="">Jannie Dvis</a>
                            </li>
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-8.jpg" class="thumb-sm br-radius">
                                </a>
                                <span class="pull-right label bg-info inline m-t-10">Webdesigner</span>
                            ...
                            <li class="list-group-item b-0">
                                <a href="" class=" m-r-10">
                                    <img src="/admin/Picture/avatar-9.jpg" class="thumb-sm br-radius">
                                </a>
                                <span class="pull-right label bg-warning inline m-t-10">Webdeveloper</span>
                                <a href="">John Deo</a>
                            </li>
