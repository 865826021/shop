...
<!-- sweet alerts -->
<link href="{{URL::asset('/admin')}}/Css/sweet-alert.min.css" rel="stylesheet">
...
<!--[if lt IE 9]>
<script src="{{URL::asset('/admin')}}/html5shiv.js"></script>
<script src="{{URL::asset('/admin')}}/respond.min.js"></script>
<![endif]-->