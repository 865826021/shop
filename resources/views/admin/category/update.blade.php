        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">分类修改</h3></div>
                    <div class="panel-body">
                        <form class="form-horizontal" action="/category/update" method="post" role="form" enctype="multipart/form-data">
